...
<? } else { ?>
<h3 style="text-align: center; color: blue">В вашей корзине пока ничего нет.</h3>
<button type="button" class="btn btn-secondary btn-close" style="width: 200px; margin-left: auto; margin-right: auto">Начать покупки</button>
<? } ?>
